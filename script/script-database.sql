...
/*CRIANDO A TABELA DE GRUPOS : registro com grupos de permissões de acesso ao sistema*/
...
/*CRIANDO A TABELA DE PERMISSÕES: armazena permissões de acesso do sistema */
...
/*CRIANDO A TABELA DE USUÁRIOS: registro dos usuarios*/
...
/*CRIANDO A TABELA DE USUÁRIO X GRUPO: vincula usuarios ao grupo de acesso ao sistema */
...
/*CRIANDO A TABELA DE PERMISSÃO X GRUPO: table com as especificas permissões de cada grupo*/
...
/*Inserindo permissões do sistema */
INSERT INTO breno.tb_permissao(id_permissao,ds_permissao,ds_descricao)
    VALUES(seq_id_permissao.NEXTVAL,'ROLE_CADASTROUSUARIO','CADASTRO DE NOVOS USUÁRIOS');
 
INSERT INTO breno.tb_permissao(id_permissao,ds_permissao,ds_descricao)
    VALUES(seq_id_permissao.NEXTVAL,'ROLE_CONSULTAUSUARIO','CONSULTA DE USUÁRIOS');                                   
    
INSERT INTO breno.tb_permissao(id_permissao,ds_permissao,ds_descricao)
    VALUES(seq_id_permissao.NEXTVAL,'ROLE_ADMIN','ADMINISTRAÇÂO COMPLETA');
    
/* Associando usuario criado com o grupo administradores*/
INSERT INTO breno.tb_usuario_x_grupo(id_usuario,id_grupo)VALUES(1,1);

/* cadastrando permissões para os grupos */
...
/*Consultando: configuração realizada*/
